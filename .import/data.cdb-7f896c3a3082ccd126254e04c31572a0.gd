...
class ItemIndex:
	...
	var all = [ItemIndexRow.new(notepad, "Notepad", "res://Sprite2D/Items/Notepad.png", 0, false, true, false, "A detective's best friend.", "Select it to save the game."), ItemIndexRow.new(badge, "Badge", "res://Sprite2D/Items/Badge.png", 1, false, true, false, "Definitive proof that you are Detective Amelia Watson. Your accomplishments are listed inside.", ""), ItemIndexRow.new(gear_case, "Gear Part Case", "res://Sprite2D/Items/GearPartCase.png", 2, false, false, false, "A container to store gear fragments.", "Collect 4 fragments to restore a gear in the pocket watch."), ItemIndexRow.new(gun, "Gun", "res://Sprite2D/Items/Gun.png", 3, false, false, false, "Your trusty revolver.", ""), ItemIndexRow.new(scroll, "Counter Spell", "res://Sprite2D/Items/Scroll.png", 4, false, false, true, "Magic incantations left behind by The Ancient Ones. ", "They can dispell purple barriers. Each scroll disintegrates after a single use.")]
